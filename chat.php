    ...
    <div class="container py-3">
        <div class="row align-items-end">
            <div class="col col-auto">
                <div id="load-file" class="svg-frame lock">
            ...
            <div class="col col-auto">
                <div id="clear-message" class="svg-frame">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            <div class="col col-auto">
                <div id="paste-message" class="svg-frame">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            <div class="col col-auto">
                <div id="rec-message" class="svg-frame">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            <div class="col col-auto">
                <div class="svg-frame" id="send-button">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
